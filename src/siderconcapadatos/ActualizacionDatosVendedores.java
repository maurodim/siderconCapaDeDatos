...
/*
 * ActualizacionDatosVendedores.java
 *
 ...
 */
public class ActualizacionDatosVendedores extends javax.swing.JInternalFrame {

    /** Creates new form ActualizacionDatosVendedores */
    private static ArrayList lista=new ArrayList();
    public ActualizacionDatosVendedores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Datos de los Vendedores");
        ...
        jLabel2.setText("Numero de Tango :");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Vendedores chof=new Vendedores();
        String nombre=(String)jTextField1.getText();
        chof.setNombre(nombre);
        String celular=(String)jTextField2.getText();
        chof.setNumero(Integer.parseInt(celular));
        lista.add(chof);
            chof.guardarVendedor(chof);
            //pr.GuardarDatosVendedores(lista);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE); 
        try {
            setClosed(true);
        } catch (PropertyVetoException ex) {
            Logger.getLogger(ActualizacionDatosVendedores.class.getName()).log(Level.SEVERE, null, ex);
        }
