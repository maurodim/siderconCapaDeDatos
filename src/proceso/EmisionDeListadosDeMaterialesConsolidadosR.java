...
public class EmisionDeListadosDeMaterialesConsolidadosR extends Thread{
    ...
    public synchronized void run(){
        ...
        String destino="////COLOSSUS//logistica//Sist HDR//LPM//"+numeroListado+" R "+this.revision+" Listado consolidado General de materiales.pdf";
        ...
        try {
            ...
            Logger.getLogger(proceso.EmisionDeListadosDeMaterialesConsolidados.class.getName()).log(Level.SEVERE, null, ex);
